...
public final class AMultiplyAdditiveExpression extends PAdditiveExpression
{
    private PMultiplicativeExpression _multiplicativeExpression_;

    public AMultiplyAdditiveExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplyAdditiveExpression(
            cloneNode(this._multiplicativeExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMultiplyAdditiveExpression(this);
    }
