...
public final class AStringLiteralLiteral extends PLiteral
{
    private TStringLiteral _stringLiteral_;

    public AStringLiteralLiteral()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStringLiteralLiteral(
            cloneNode(this._stringLiteral_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStringLiteralLiteral(this);
    }
