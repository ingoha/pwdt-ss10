...
public class DeleteIndicationMenuAction extends Action implements ISelectionListener, ActionFactory.IWorkbenchAction
{
	private final IWorkbenchWindow window;
	public final static String ID = "org.gello.client.actions.contextMenu.DeleteIndication";
	private IStructuredSelection selection;

	public DeleteIndicationMenuAction(IWorkbenchWindow window)
	{
		this.window = window;
		setId(ID);
		setText("&Delete Indication");
		setToolTipText("Delete Indication.");
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.DELETE_INDICATION));
