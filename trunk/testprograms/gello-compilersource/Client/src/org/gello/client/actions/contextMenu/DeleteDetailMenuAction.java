...
public class DeleteDetailMenuAction extends Action implements ISelectionListener, ActionFactory.IWorkbenchAction
{

	private final IWorkbenchWindow window;

	public final static String ID = "org.gello.client.actions.contextMenu.DeleteDetail";

	private IStructuredSelection selection;

	public DeleteDetailMenuAction(IWorkbenchWindow window)
	{
		this.window = window;
		setId(ID);
		setText("&Delete Detail");
		setToolTipText("Delete Detail.");
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.DELETE_DETAIL));
