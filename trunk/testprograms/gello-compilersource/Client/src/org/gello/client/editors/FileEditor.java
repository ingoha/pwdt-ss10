...
public class FileEditor extends EditorPart
{
	...
	public void createPartControl(Composite parent)
	{
		...
		// Add the toolbar items with text showing.
		...
		// When the text is modified, fire the property change for
		// being dirty and set save to enabled if it's editable and dirty.
	...
	{
		if (fileData != null && !fileData.isDisposed())
			fileData.setFocus();
		refreshEditor();
	}
