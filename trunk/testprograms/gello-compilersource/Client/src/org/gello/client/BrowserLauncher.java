 ...
 * <p>
 * Anyway, this code is completely in Java and will run on all JDK 1.1(or
 * better)-compliant systems without modification or a need for additional
 ...
 * will not cause this to do anything other than returning an error when opening
 * the browser.
 * <p>
 ...
 * 66</a>) <br>
 * Ron B. Yeh, ZeroG <br>
 * Ben Engber, The New York Times <br>
...
/*
 * Fixed a minor bug that kept browser from launching on Solaris
 * (NETSCAPE_OPEN_PARAMETER_START doesn't work with "'") and added main class
 * driver so that changes could be easily checked. Haven't verified against
 * other Unix flavors. Aaron Miller (<a
 * href="mailto:aaronmiller@hotmail.com">aaronmiller@hotmail.com</a>)
 */
	...
	static
	{
		...
		if ("Mac OS".equals(osName))
		{
			...
			try
			{
				...
				{
					// For the time being, assume that all post-2.0 versions of
					// MRJ work the same
					jvm = MRJ_2_1;
				}
				else
