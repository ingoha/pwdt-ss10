...
set dietician_path [ lindex $xlateInList 0 ]
set dh [xpmfetch $xlateId $dietician_path ] 
set dietician_code [ datget $dh VALUE ]

# The funtionality of the above three lines could also have
# been achieved by using the following:
