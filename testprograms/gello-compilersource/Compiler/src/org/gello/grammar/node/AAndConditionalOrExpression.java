...
public final class AAndConditionalOrExpression extends PConditionalOrExpression
{
    private PConditionalAndExpression _conditionalAndExpression_;

    public AAndConditionalOrExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndConditionalOrExpression(
            cloneNode(this._conditionalAndExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAAndConditionalOrExpression(this);
    }
