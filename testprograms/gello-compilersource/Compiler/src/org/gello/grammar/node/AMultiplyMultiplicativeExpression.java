...
public final class AMultiplyMultiplicativeExpression extends PMultiplicativeExpression
{
    private PMultiplicativeExpression _multiplicativeExpression_;
    private TStar _star_;
    private PUnaryExpression _unaryExpression_;

    public AMultiplyMultiplicativeExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplyMultiplicativeExpression(
    ...
    {
        ((Analysis) sw).caseAMultiplyMultiplicativeExpression(this);
    }
