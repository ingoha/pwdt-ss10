...
public final class AXorConditionalOrExpression extends PConditionalOrExpression
{
    ...
    public Object clone()
    {
        return new AXorConditionalOrExpression(
    ...
    {
        ((Analysis) sw).caseAXorConditionalOrExpression(this);
    }
