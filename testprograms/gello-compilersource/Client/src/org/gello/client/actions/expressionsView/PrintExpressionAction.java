...
public class PrintExpressionAction extends Action implements ISelectionListener, ActionFactory.IWorkbenchAction
{
	public final static String ID = "org.gello.client.actions.projectsView.PrintExpression";
	private IStructuredSelection selection;
	private IWorkbenchWindow window;

	public PrintExpressionAction(IWorkbenchWindow window)
	{
		this.window = window;
		setId(ID);
		setText("&Print");
		setToolTipText("Print Expression");
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.PRINT_EXPRESSION));
	...
	public void run()
	{
		// TODO Implement Expression Printer.
