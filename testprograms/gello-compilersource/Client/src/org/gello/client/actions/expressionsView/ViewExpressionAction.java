...
public class ViewExpressionAction extends Action implements ISelectionListener, ActionFactory.IWorkbenchAction
{
	public final static String ID = "org.gello.client.actions.projectsView.ViewExpression";
	private IStructuredSelection selection;
	private IWorkbenchWindow window;

	public ViewExpressionAction(IWorkbenchWindow window)
	{
		this.window = window;
		setId(ID);
		setText("&View");
		setToolTipText("View Expression");
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.VIEW_EXPRESSION));
	...
	public void run()
	{
		// TODO Implement View Expression Action.
