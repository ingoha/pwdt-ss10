...
public final class ACollectionGelloType extends PGelloType
{
    private PCollectionType _collectionType_;

    public ACollectionGelloType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACollectionGelloType(
            cloneNode(this._collectionType_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACollectionGelloType(this);
    }
